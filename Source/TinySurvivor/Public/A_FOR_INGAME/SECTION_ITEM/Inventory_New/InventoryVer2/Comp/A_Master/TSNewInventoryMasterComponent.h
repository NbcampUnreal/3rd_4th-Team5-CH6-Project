...
#include "A_FOR_INGAME/SECTION_ITEM/Inventory_New/InventoryVer2/Interface/ForComp/TSNewInventoryCompActionInterface.h"
#include "TSNewInventoryMasterComponent.generated.h"
...
class TINYSURVIVOR_API UTSNewInventoryMasterComponent : public UActorComponent, public ITSNewInventoryCompActionInterface
{
	GENERATED_BODY()
...
public:
	UTSNewInventoryMasterComponent();											// 리플리케이트 On, 틱 false
...
public:
	...
	virtual bool AddItemToInventory_Implementation(FTSNewItemRuntimeData InItemRuntimeData) override;							// 아이템 습득 
	virtual bool RemoveItemFromInventory_Implementation(FTSNewItemRuntimeData InItemRuntimeData) override;						// 아이템 제거 
	virtual bool DropItemToFromInventory_Implementation(FTSNewItemRuntimeData InItemRuntimeData) override;						// 아이템 드랍
	virtual bool SwapItemFromThisInventoryToAnotherInventory_Implementation(FTSNewItemRuntimeData InItemRuntimeData) override;	// 아이템 스왑 
	// ~ ITSNewEquipVisualCompActionInterface
...
protected:
	...
	bool TrayAddNoneStackItem_internal(FTSNewItemRuntimeData& InItemRuntimeData);	// 비 스택 아이템 넣기 
	bool TrayAddStackItem_internal(FTSNewItemRuntimeData& InItemRuntimeData);		// 스택 아이템 넣기
...
protected:
	...
	FTSNewInventoryCompData InventoryData;
