// GA_ConsumeItem_DualEffect_Base.h
...
#include "GA_ConsumeItem_DualEffect_Base.generated.h"
...
/*
	...
	2. 블루프린트에서 ItemID 설정
	3. 블루프린트에서 GameplayEffect 2개 설정
...
class TINYSURVIVOR_API UGA_ConsumeItem_DualEffect_Base : public UGameplayAbility
{
	GENERATED_BODY()
	
public:
	UGA_ConsumeItem_DualEffect_Base();
...
protected:
	...
	*/
	...
	/*
		RemoveTag 용도 GameplayEffect 클래스
	*/
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Item Configuration",
		meta = (DisplayName = "RemoveTag Effect Class", ToolTip = "RemoveTag용 GameplayEffect 클래스"))
	TSubclassOf<UGameplayEffect> RemoveTagEffectClass;
	
	/*
		AddTag 용도 GameplayEffect 클래스
	*/
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Item Configuration",
		meta = (DisplayName = "AddTag Effect Class", ToolTip = "AddTag용 GameplayEffect 클래스"))
	TSubclassOf<UGameplayEffect> AddTagEffectClass;
#pragma endregion
