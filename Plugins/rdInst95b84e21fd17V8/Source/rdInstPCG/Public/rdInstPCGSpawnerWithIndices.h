// rdInstPCGSpawnerWithIndices.h - Copyright (c) 2024 Recourse Design ltd.
#pragma once
...
#include "rdInstPCGSpawnerWithIndices.generated.h"
...
class RDINST_PLUGIN_API UPCGrdInstStaticMeshSpawnerWithIndicesSettings : public UPCGStaticMeshSpawnerSettings {
	GENERATED_BODY()
public:
	UPCGrdInstStaticMeshSpawnerWithIndicesSettings(const FObjectInitializer &ObjectInitializer);
#if WITH_EDITOR
...
#endif
	virtual FName				GetDefaultNodeName() const override { return FName(TEXT("rdInst StaticMeshSpawner with Indices")); }
...
class RDINST_PLUGIN_API FPCGrdInstSpawnerWithIndicesElement : public IPCGElement {
public:
...
#endif
	void				 spawnISMs(FPCGStaticMeshSpawnerContext* ctx,const FPCGMeshInstanceList& instList,AActor* owner,const FPCGPackedCustomData& packedCustomData,TArray<int32>& indices) const;
#if ENGINE_MINOR_VERSION>3
